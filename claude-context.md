...
**Fases 0 a 4 concluídas.** A Fase 1 foi mergeada na `main` (PR #4). As Fases 2 e 3 foram mergeadas via PR [#5](https://github.com/betinn/GDSB.MAUI/pull/5) (incluindo a migração net8.0→net10.0 e os bugfixes do primeiro teste manual, ver abaixo — nada disso foi uma fase nova, foi ambiente + polish em cima da Fase 3). A Fase 4 está nesta branch.
